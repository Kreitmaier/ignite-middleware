...
Foi disponibilizado um template com as assinaturas dos middleware para serem implementados.

No template existe também testes que ajudaram no desenvolvimento do app e conclusão do desafio.
...
- Exclui um *todo*;
- Existe um **plano grátis onde o usuário só pode criar até dez *todos*** e um **plano Pro que irá permitir criar *todos* ilimitados.**

## Middlewares - Proposta de desenvolvimento.
